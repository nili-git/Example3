...
class Peacepark1 extends StatefulWidget {
  //const DescriptionPageWidget({ Key? key }) : super(key: key);

  @override
  _Peacepark1State createState() => _Peacepark1State();
}

class _Peacepark1State extends State<Peacepark1> {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'Its an newly born place in Butwal, and can be also called as symbol of peace. Many international celebrities, tourists and models are attracted here for its own beauty and excellence.',
                      style: TextStyle(
                        fontFamily: 'Lexend Deca',
