...
class MukundaSen1 extends StatefulWidget {
  //const DescriptionPageWidget({ Key? key }) : super(key: key);

  @override
  _MukundaSen1State createState() => _MukundaSen1State();
}

class _MukundaSen1State extends State<MukundaSen1> {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'The winter palace of Palpali Sen clan is very fascinating from natural and archaeological values. There are ruins and antiquities of the majestic palace of Manimukunda Sen an ancient Palpali king containing 6 large rooms as well as royal residence, administrative and fascinating scenic grandeur of Butwal, Siddharthanagar and other neighbouring villages of Rupandehi district can be vividly seen from here at night also. His Majestys Government, archaeological department has attempted to maintain it in 1991. Now Butwal municipality has formed council for the conservation of Manimukunda Sen Park to conduct Phulbari Development Programme and attempted to make it an amusing and a tourist resort.',
                      style: TextStyle(
                        fontFamily: 'Lexend Deca',
