...
class UserAddedPlaces extends StatefulWidget {
  @override
  _UserAddedPlacesState createState() => _UserAddedPlacesState();
}

class _UserAddedPlacesState extends State<UserAddedPlaces> {
  List places = List();
  Future getdata() async {
    var url = 'http://192.168.100.1/php/read.php';
    var response =
