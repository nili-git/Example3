...
class _CategoryWidget2State extends State<CategoryWidget2> {
  ...
  Future getdata() async {
    var url = 'http://192.168.100.174/php/readparks.php';
...
// import 'package:places_autocomplete/kunjalapur.dart';
// import 'package:places_autocomplete/milanpark.dart';
// import 'package:places_autocomplete/peacepark.dart';
...
//                     GestureDetector(
//                               onTap: (){
//                                Navigator.push(context, MaterialPageRoute(builder: (context)=>KunjalaPur1()));
//                               },
...
//     GestureDetector(
//                     onTap: (){
//                 Navigator.push(context, MaterialPageRoute(builder: (context)=>Peacepark1()));
//                     },
...
//                      GestureDetector(
//                               onTap: (){
//                              Navigator.push(context, MaterialPageRoute(builder: (context)=>Milanpark1()));
//                               },
